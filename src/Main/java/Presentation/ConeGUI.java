...
public class ConeGUI extends ShapeGUI {
    ...
    /**
     * Displaylayout for Cone use GridBagConstraints for textfield and buttons.
     * @param shape
     * @param overviewGUI
     */
    public ConeGUI(Cone shape, OverviewGUI overviewGUI) {
    ...
    public Shape toShape() {
        ...
        try {
            ((Cone) this.shape).setRadius(Double.parseDouble(radiusField.getText().replace(',', '.')));
            if (((Cone) this.shape).getRadius() == 0.0) {
        ...
        try {
            ((Cone) this.shape).setHeight(Double.parseDouble(heightField.getText().replace(',', '.')));
            if (((Cone) this.shape).getHeight() == 0.0) {
